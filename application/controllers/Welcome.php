	...
	public function select_ms($date_yesterday){
		foreach($this->tables as $i => $tbl){
		 ...
		 /***rhan*** start**/
							switch ($i) {
							 case 'Movements':
							  # code...
							  $record["ToDescription"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["ToDescription"]); 
							  $record["ToAddress"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["ToAddress"]); 
							  $record["ContactPerson"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["ContactPerson"]); 
							  break;
							 case 'Receiving':
							  # code...
							  $record["Description"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["Description"]); 
							  $record["Address"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["Address"]); 
							  $record["ContactPerson"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["ContactPerson"]); 
							  $record["Remarks"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @ ]/", "", $record["Remarks"]); 
							  break;
		...
		/***rhan*** start**/
					   switch ($child_index) {
						case 'MovementLine':
						 # code...
						 $child["Description"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @]/", "", $child["Description"]); 
						 break;
						case 'ReceivingLine':
						 # code...
						 $child["Description"] =  preg_replace("/[^a-zA-Z 0-9 . : ! () @]/", "", $child["Description"]);
